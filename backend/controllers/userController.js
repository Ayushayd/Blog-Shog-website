...
export const register = catchAsyncErrors(async (req, res, next)=> {
    ...
    if(!allowedFormats.includes(avatar.mimetype)){
        return next(new ErrorHandler("Invalid avatar image format type, Plese provide avatar in png, jpg or webp format.",400));
    }
    ...
    sendToken(user, 200, "User registerd successfully", res);
});
